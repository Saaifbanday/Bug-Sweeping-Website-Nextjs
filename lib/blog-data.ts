...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: `
      ...
      <p>The most common vector for a planted device is physical access. A visitor who arrives early and is left alone in the meeting room, a maintenance contractor who works unsupervised, a delivered package that was opened inside the office — all represent planting opportunities. If any of these have occurred before a period of unusual information leakage, a sweep is warranted.</p>
  ...
  },
  {
    ...
    content: `
      <p>GPS tracking devices have become extraordinarily small, inexpensive, and long-lasting. The latest generation of covert trackers operate for 60–90 days on a single charge, transmit real-time location data over GSM networks, and cost less than ₹3,000. They can be attached to any metal surface on a vehicle in seconds — no access to the interior required.</p>
